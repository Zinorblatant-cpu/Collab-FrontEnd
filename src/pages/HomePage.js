      ...
      <main className='max-w-6xl mx-auto mt-10'>
        ...
        <section className="fixed left-0 top-0 h-screen w-20 bg-black flex flex-col justify-between items-center py-10 outline outline-yellow-500">
          ...
          <div>
            ...
            <Link to="/">
            <button className="bg-yellow-500 w-12 h-12 flex items-center justify-center rounded-xl text-black">
            ...
            <Link to="/class">       
            <button className="bg-zinc-800 w-12 h-12 flex items-center justify-center rounded-xl mt-10">
          ...
          <div>
            <Link to="/config">
            <button className="bg-zinc-800 w-12 h-12 flex items-center justify-center rounded-xl">
